...
|
*/
$config['rest_realm'] = 'RFLREALMGROWFAST';
...
// $config['auth_override_class_method_http']['auth']['index']['post'] = 'none';
// $config['auth_override_class_method_http']['authx']['index']['post'] = 'none';
...
| error message 'Only AJAX requests are accepted.' will be returnebd.
|
